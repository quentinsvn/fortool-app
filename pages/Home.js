    ...
    return (
        ...
        <Content style={{marginRight: 10, marginLeft: 10}}>
          ...
          <CardItem header button>
              <Text style={{fontWeight: 'bold'}}>Mon solde</Text>
            </CardItem>
            <CardItem>
              <Body style={{flexDirection: "row", justifyContent: "center"}}>
                <Text style={{fontSize: 40, fontWeight: '500', color: '#F76700'}}>
                   640 Fortcoins
                </Text>
              </Body>
            </CardItem>
          ...
          <Card>
            <CardItem header>
              <Text style={{fontWeight: 'bold'}}>Niveau</Text>
            </CardItem>
            <CardItem>
              <Body style={{flexDirection: "row", justifyContent: "center"}}>
                <Text style={{fontSize: 40, fontWeight: '500', color: '#F76700'}}>
          ...
          <Card>
            <CardItem header>
              <Text style={{fontWeight: 'bold'}}>Commandes</Text>
            </CardItem>
            <CardItem>
              <Body style={{flexDirection: "row", justifyContent: "center"}}>
                <Text style={{fontSize: 40, fontWeight: '500', color: '#F76700'}}>
